...
function FunctionCreatorSteps(){
    ...
    const SelectForParameters = React.memo(({ value, index, options, setFunctionParameters, prop }) => {
        return (
            <Select
        ...
        () => [
            ...
            },
            {
                ...
                control: ({ value = '' }, itemIndex) => (
                    /*functionParameters[itemIndex] !== undefined &&*/ console.log(functionParameters) /*&& functionParameters[itemIndex].type.value === "bool"*/ ?
                        <SelectForParameters
                            prop="value"
                            value={value}
                            index={itemIndex}
    ...
    function exportFunctionToJson(){
        ...
        functionParameters.forEach((parameter) =>{
           if(parameter.type.value === "int" || parameter.type.value === "str"){
